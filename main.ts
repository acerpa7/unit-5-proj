scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
game.splash("Should you dump him?")
...
let mySprite2 = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
mySprite2.setPosition(7, 59)
let mySprite3 = sprites.create(img`
    ................................
    ................................
    ................................
    .ffff.f.ff..f.ffff.f...fff......
    .f....f.ff..f.f....f...f........
    .f....f.f.f.f.f....f...f........
    .ffff.f.f.f.f.f....f...f........
    ....f.f.f..ff.f.ff.f...ff.......
    ....f.f.f..ff.f..f.f...f........
    .ffff.f.f...f.ffff.fff.fff......
    ................................
    .....f...fff.ff..f...f..f.......
    .....f...f.f.f.f.ff.ff..f.......
    .....f...f.f.f.f..fff...f.......
    ...
    ................................
    `, SpriteKind.Player)
mySprite3.setPosition(145, 65)
let response1 = game.askForString("Is he rich? Answer \"yes\" or \"no\"", 3)
if (response1 == "yes") {
    pause(200)
    mySprite.x += -15
...
pause(1000)
game.splash("How tall is he?")
let response2 = game.askForNumber("in inches", 2)
if (response2 < 72) {
    pause(200)
    mySprite.x += 15
    info.changeScoreBy(-10)
